...
// Используем прокси, чтобы обойти блокировку CORS
const URL = 'https://corsproxy.io/?' + encodeURIComponent('https://jsonblob.com/api/jsonBlob/019ae59e-d6cd-78dc-9d94-edb43c4c2d9c');
let animeData = [];
